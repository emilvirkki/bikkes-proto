...
<div class="field time">
	...
	<input type="datetime-local" name="from_time" step="1800" min="<?php print date("Y-m-d\TH:00\Z"); ?>" value="<?php print date("Y-m-d\TH:00\Z"); ?>">
	</label>
</div>
...
<div class="field time">
	<label>
	<span><?php print t('At:'); ?></span>
	<input type="datetime-local" name="to_time" step="1800" min="<?php print date("Y-m-d\TH:00\Z"); ?>" value="<?php print date("Y-m-d\TH:00\Z"); ?>">
	</label>
</div>
